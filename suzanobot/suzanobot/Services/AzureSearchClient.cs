...
namespace suzanobot.Services
{
    ...
    public class AzureSearchClient
    {
        ...
        private readonly IMapper<DocumentSearchResult, DocumentSearchResult> mapper;
        ...
        //public async Task<DocumentSearchResult> SearchAsync(SearchQueryBuilder queryBuilder, string refiner)
        //{
